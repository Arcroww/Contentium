...
public class RedSandStoneWall extends BlockWall {
	private static final String __OBFID = "CL_00000331";

	public RedSandStoneWall() {
		super(ModBlocks.red_sandstone);
		this.setHardness(0.8F);
		this.setResistance(1);
		this.setStepSound(soundTypeStone);
		this.setCreativeTab(CreativeTabs.tabDecorations);
		setBlockName(Utils.getUnlocalisedName("red_sandstone_wall"));
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return ModBlocks.red_sandstone.getBlockTextureFromSide(p_149691_1_);
	}
