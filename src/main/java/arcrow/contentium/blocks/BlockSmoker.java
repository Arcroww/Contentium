...
public class BlockSmoker extends BlockContainer
{
    ...
    public BlockSmoker(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Reference.MOD_ID + ":smoker/smoker_side");
        this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? Reference.MOD_ID + ":smoker/smoker_front_on" : Reference.MOD_ID + ":smoker/smoker_front_off");
        this.field_149935_N = p_149651_1_.registerIcon(Reference.MOD_ID + ":smoker/smoker_top");
    }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntitySmoker)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
        }
    }
