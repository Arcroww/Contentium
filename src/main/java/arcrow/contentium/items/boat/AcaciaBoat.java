...
public class AcaciaBoat extends Item
{
    ...
    public AcaciaBoat()
    {
        ...
        this.setTextureName(Reference.MOD_ID + ":boat/acacia_boat");
        setUnlocalizedName(Utils.getUnlocalisedName("acacia_boat"));
    }
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    EntityAcaciaBoat EntityAcaciaBoat = new EntityAcaciaBoat(p_77659_2_, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
                    EntityAcaciaBoat.rotationYaw = (float)(((MathHelper.floor_double((double)(p_77659_3_.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);

                    if (!p_77659_2_.getCollidingBoundingBoxes(EntityAcaciaBoat, EntityAcaciaBoat.boundingBox.expand(-0.1D, -0.1D, -0.1D)).isEmpty())
                    {
                        return p_77659_1_;
                    }
                    ...
                    {
                        p_77659_2_.spawnEntityInWorld(EntityAcaciaBoat);
                    }
