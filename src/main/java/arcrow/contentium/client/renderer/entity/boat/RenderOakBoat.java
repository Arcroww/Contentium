...
public class RenderOakBoat extends Render
{
    private static final ResourceLocation boatTextures = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/oak.png");
    protected ModelBase modelBoat;

    public RenderOakBoat() {
        this.shadowSize = 0.5F;
        this.modelBoat = new ModelOakBoat();
    }

    public void doRender(EntityOakBoat boat, double x, double y, double z, float yaw, float partTicks) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double x, double y, double z, float yaw, float partTicks) {
        this.doRender((EntityOakBoat)entity, x, y, z, yaw, partTicks);
    }
}