...
public class BlockNewPressurePlate extends BlockBasePressurePlate
{
    private BlockPressurePlate.Sensitivity field_150069_a;
    private static final String __OBFID = "CL_00000289";

    public BlockNewPressurePlate(String p_i45418_1_, Material p_i45418_2_, BlockPressurePlate.Sensitivity p_i45418_3_)
    {
