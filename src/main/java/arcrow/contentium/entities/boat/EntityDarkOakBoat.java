package arcrow.contentium.entities.boat;
...
public class EntityDarkOakBoat extends Entity
{
    ...
    public EntityDarkOakBoat(World p_i1704_1_)
    {
        super(p_i1704_1_);
    ...
    public EntityDarkOakBoat(World p_i1705_1_, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
    {
        this(p_i1705_1_);
    ...
    public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (flag || this.getDamageTaken() > 40.0F)
            {
                ...
                if (!flag)
                {
                    this.func_145778_a(ModItems.dark_oak_boat, 1, 0.0F);
                }
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (int k1 = 0; k1 < list.size(); ++k1)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityDarkOakBoat)
                        {
	...
	public float func_184448_a(int p_renderPaddle_2_, float p_renderPaddle_4_) {
