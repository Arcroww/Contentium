...
import arcrow.contentium.client.model.boat.ModelBirchBoat;
...
public class RenderBirchBoat extends Render
{
    private static final ResourceLocation boatTextures = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/birch.png");
    protected ModelBase modelBoat;

    public RenderBirchBoat() {
        this.shadowSize = 0.5F;
        this.modelBoat = new ModelBirchBoat();
    }

    public void doRender(EntityBirchBoat boat, double x, double y, double z, float yaw, float partTicks) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double x, double y, double z, float yaw, float partTicks) {
        this.doRender((EntityBirchBoat)entity, x, y, z, yaw, partTicks);
    }
}