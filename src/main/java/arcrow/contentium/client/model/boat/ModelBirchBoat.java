...
public class ModelBirchBoat extends ModelBase implements IMultipassModel {
    ...
    public void render(Entity p_render_1_, float p_render_2_, float p_render_3_, float p_render_4_, float p_render_5_, float p_render_6_, float p_render_7_) {
        ...
        EntityBirchBoat lvt_8_1_ = (EntityBirchBoat)p_render_1_;
    ...
    void renderPaddle(EntityBirchBoat p_renderPaddle_1_, int p_renderPaddle_2_, float p_renderPaddle_3_, float p_renderPaddle_4_) {
