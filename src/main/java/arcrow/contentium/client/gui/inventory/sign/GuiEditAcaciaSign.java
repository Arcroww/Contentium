package arcrow.contentium.client.gui.inventory.sign;
...
public class GuiEditAcaciaSign extends GuiScreen
{
    /** Reference to the sign object. */
    private TileEntityAcaciaSign tileSign;
    ...
    public GuiEditAcaciaSign(TileEntityAcaciaSign p_i1097_1_)
    {
