package arcrow.contentium.blocks.signs;
...
public class DarkOakSignBlock extends BlockContainer
{
    private Class field_149968_a;
    private boolean field_149967_b;
    private static final String __OBFID = "CL_00000306";

    public DarkOakSignBlock(Class p_i45426_1_, boolean p_i45426_2_)
    {
        super(Material.wood);
