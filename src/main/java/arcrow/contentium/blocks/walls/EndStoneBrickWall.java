...
public class EndStoneBrickWall extends BlockWall {
	private static final String __OBFID = "CL_00000331";

	public EndStoneBrickWall() {
		super(ModBlocks.end_bricks);
		this.setHardness(3F);
		this.setResistance(9);
		this.setStepSound(soundTypeStone);
		this.setCreativeTab(CreativeTabs.tabDecorations);
		setBlockName(Utils.getUnlocalisedName("end_brick_wall"));
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return ModBlocks.end_bricks.getBlockTextureFromSide(p_149691_1_);
	}
