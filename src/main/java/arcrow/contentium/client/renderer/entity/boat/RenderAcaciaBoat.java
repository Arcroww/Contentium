...
import arcrow.contentium.client.model.boat.ModelAcaciaBoat;
...
public class RenderAcaciaBoat extends Render
{
    private static final ResourceLocation boatTextures = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/acacia.png");
    protected ModelBase modelBoat;

    public RenderAcaciaBoat() {
        this.shadowSize = 0.5F;
        this.modelBoat = new ModelAcaciaBoat();
    }

    public void doRender(EntityAcaciaBoat boat, double x, double y, double z, float yaw, float partTicks) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double x, double y, double z, float yaw, float partTicks) {
        this.doRender((EntityAcaciaBoat)entity, x, y, z, yaw, partTicks);
    }
}