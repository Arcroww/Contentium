...
public class EntityAcaciaBoat extends Entity
{
    ...
    public EntityAcaciaBoat(World p_i1704_1_)
    {
        super(p_i1704_1_);
    ...
    public EntityAcaciaBoat(World p_i1705_1_, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
    {
        this(p_i1705_1_);
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (int k1 = 0; k1 < list.size(); ++k1)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityAcaciaBoat)
                        {
