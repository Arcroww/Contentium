...
public class EntitySpruceBoat extends Entity
{
    ...
    public EntitySpruceBoat(World p_i1704_1_)
    {
        super(p_i1704_1_);
    ...
    public EntitySpruceBoat(World p_i1705_1_, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
    {
        this(p_i1705_1_);
    ...
    public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (flag || this.getDamageTaken() > 40.0F)
            {
                ...
                if (!flag)
                {
                    this.func_145778_a(ModItems.spruce_boat, 1, 0.0F);
                }
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (int k1 = 0; k1 < list.size(); ++k1)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntitySpruceBoat)
                        {
