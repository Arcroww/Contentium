package arcrow.contentium.tileentities;

import arcrow.contentium.blocks.BlockBlastFurnace;
import arcrow.contentium.recipes.BlastFurnaceRecipes;
...
public class TileEntityBlastFurnace extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.hasCustomInventoryName() ? this.field_145958_o : "container.blast_furnace";
    }
