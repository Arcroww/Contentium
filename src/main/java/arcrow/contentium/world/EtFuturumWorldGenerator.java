package arcrow.contentium.world;
...
public class EtFuturumWorldGenerator implements IWorldGenerator {
	...
	public EtFuturumWorldGenerator() {
		generators.add(new WorldGenMinable(ModBlocks.stone, 1, Contentium.maxStonesPerCluster, Blocks.stone));
		generators.add(new WorldGenMinable(ModBlocks.stone, 3, Contentium.maxStonesPerCluster, Blocks.stone));
		generators.add(new WorldGenMinable(ModBlocks.stone, 5, Contentium.maxStonesPerCluster, Blocks.stone));
	}

	@Override
	public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
		if (Contentium.enableCoarseDirt && world.provider.dimensionId != -1 && world.provider.dimensionId != 1)
		...
		if (Contentium.enableStones && Contentium.maxStonesPerCluster > 0 && world.provider.dimensionId != -1 && world.provider.dimensionId != 1)
		...
		if (Contentium.enablePrismarine && world.provider.dimensionId != -1 && world.provider.dimensionId != 1)
		...
		if (Contentium.enableChorusFruit && world.provider.dimensionId == 1) {
			int x = chunkX * 16 + rand.nextInt(16);
			int y = 256;
			int z = chunkZ * 16 + rand.nextInt(16);
			for (; y > 0; y--)
