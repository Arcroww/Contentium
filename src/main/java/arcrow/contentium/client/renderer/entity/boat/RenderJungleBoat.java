...
import arcrow.contentium.client.model.boat.ModelJungleBoat;
...
public class RenderJungleBoat extends Render
{
    private static final ResourceLocation boatTextures = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/jungle.png");
    protected ModelBase modelBoat;

    public RenderJungleBoat() {
        this.shadowSize = 0.5F;
        this.modelBoat = new ModelJungleBoat();
    }

    public void doRender(EntityJungleBoat boat, double x, double y, double z, float yaw, float partTicks) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double x, double y, double z, float yaw, float partTicks) {
        this.doRender((EntityJungleBoat)entity, x, y, z, yaw, partTicks);
    }
}