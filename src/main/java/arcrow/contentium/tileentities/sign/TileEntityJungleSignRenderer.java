...
public class TileEntityJungleSignRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147513_b = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/sign/jungle.png");
    private final ModelSign field_147514_c = new ModelSign();
    private static final String __OBFID = "CL_00000970";

    public void renderTileEntityAt(TileEntityJungleSign p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        ...
        if (block == ModBlocks.standing_jungle_sign)
        {
    ...
    {
        this.renderTileEntityAt((TileEntityJungleSign)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}