...
public class MossyStoneBrickWall extends BlockWall {
	...
	public MossyStoneBrickWall() {
		...
		setBlockName(Utils.getUnlocalisedName("mossy_cobblestone_wall"));
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return Blocks.mossy_cobblestone.getBlockTextureFromSide(p_149691_1_);
	}
