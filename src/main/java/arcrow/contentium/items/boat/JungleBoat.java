...
public class JungleBoat extends Item
{
    ...
    public JungleBoat()
    {
        ...
        this.setTextureName(Reference.MOD_ID + ":boat/jungle_boat");
        setUnlocalizedName(Utils.getUnlocalisedName("jungle_boat"));
    }
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    EntityJungleBoat EntityJungleBoat = new EntityJungleBoat(p_77659_2_, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
                    EntityJungleBoat.rotationYaw = (float)(((MathHelper.floor_double((double)(p_77659_3_.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) - 1) * 90);

                    if (!p_77659_2_.getCollidingBoundingBoxes(EntityJungleBoat, EntityJungleBoat.boundingBox.expand(-0.1D, -0.1D, -0.1D)).isEmpty())
                    {
                        return p_77659_1_;
                    }
                    ...
                    {
                        p_77659_2_.spawnEntityInWorld(EntityJungleBoat);
                    }
