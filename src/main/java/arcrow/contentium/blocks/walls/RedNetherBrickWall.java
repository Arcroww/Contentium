...
public class RedNetherBrickWall extends BlockWall {
	private static final String __OBFID = "CL_00000331";

	public RedNetherBrickWall() {
		super(ModBlocks.red_nether_brick);
		this.setHardness(1.5F);
		this.setResistance(6);
		this.setStepSound(soundTypeStone);
		this.setCreativeTab(CreativeTabs.tabDecorations);
		setBlockName(Utils.getUnlocalisedName("red_nether_brick_wall"));
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return ModBlocks.red_nether_brick.getBlockTextureFromSide(p_149691_1_);
	}
