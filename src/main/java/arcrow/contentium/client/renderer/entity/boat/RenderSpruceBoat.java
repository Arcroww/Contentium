...
import arcrow.contentium.client.model.boat.ModelOakBoat;
import arcrow.contentium.client.model.boat.ModelSpruceBoat;
...
{
    private static final ResourceLocation boatTextures = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/spruce.png");
    protected ModelBase modelBoat;

    public RenderSpruceBoat() {
        this.shadowSize = 0.5F;
        this.modelBoat = new ModelSpruceBoat();
    }

    public void doRender(EntitySpruceBoat boat, double x, double y, double z, float yaw, float partTicks) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double x, double y, double z, float yaw, float partTicks) {
        this.doRender((EntitySpruceBoat)entity, x, y, z, yaw, partTicks);
    }
}