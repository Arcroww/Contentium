...
public class BlockBlastFurnace extends BlockContainer
{
    ...
    public BlockBlastFurnace(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Reference.MOD_ID + ":blast_furnace/blast_furnace_side");
        this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? Reference.MOD_ID + ":blast_furnace/blast_furnace_front_on" : Reference.MOD_ID + ":blast_furnace/blast_furnace_front");
        this.field_149935_N = p_149651_1_.registerIcon(Reference.MOD_ID + ":blast_furnace/blast_furnace_top");
    }
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        if(p_149727_1_.isRemote) {
        	...
        	p_149727_5_.openGui(Contentium.instance, 1, p_149727_1_, p_149727_2_, p_149727_3_, p_149727_4_);
        	return true;
        }
    }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityBlastFurnace)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
        }
    }
