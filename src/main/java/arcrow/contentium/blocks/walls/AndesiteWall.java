...
public class AndesiteWall extends BlockWall {
	private static final String __OBFID = "CL_00000331";

	public AndesiteWall() {
		super(ModBlocks.andesite_slab);
		this.setHardness(1.5F);
		this.setResistance(6);
		this.setStepSound(soundTypeStone);
		this.setCreativeTab(CreativeTabs.tabDecorations);
		setBlockName(Utils.getUnlocalisedName("andesite_wall"));
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return ModBlocks.andesite_slab.getBlockTextureFromSide(p_149691_1_);
	}
